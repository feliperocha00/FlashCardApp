...
var frente = document.getElementById("frentedocartao");
var verso = document.getElementById("versodocartao");
...
function antCart() {
  ...
  else if (indiceCartao === 0) indiceCartao = meusCartoes.length-1;
  frente.innerHTML = meusCartoes[indiceCartao].termo;
  verso.innerHTML = meusCartoes[indiceCartao].definicao;
